              ...
              <div className="metaverse">
                <Slider {...settings}>
                  ...
                  <div className="">
                    <div className="partner-logo">
                      <img
                        src="./assets/img/metaversepartners/hub/34.png"
                        style={{ width: "60%", height: "60%" }}
                      />
                    </div>
                    <div className="partner-logo">
                      <img
                        src="./assets/img/metaversepartners/hub/35.png"
                  ...
                  <div className="">
                    <div className="partner-logo">
                      <img
                        src="./assets/img/metaversepartners/hub/36.png"
                        style={{ width: "70%", height: "60%" }}
                      />
                    </div>
                    <div className="partner-logo">
                      <img
                        src="./assets/img/metaversepartners/hub/38.png"
                        style={{ width: "70%", height: "30%" }}
                      />
                    </div>
                  </div>
              ...
              <div className="investor">
                <Slider {...settings}>
                  ...
                  <div className="">
                    <div className="partner-logo investor-logo">
                      <img
                        src="./assets/img/backerInvestors/pic/9.png"
